                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="milestone-content-header" onClick={(e) => toggleMilestoneCollapse(ms.id, e)} style={{ cursor: 'pointer' }}>
                                <h3 className="milestone-title-text" style={{ fontSize: '0.95rem', fontWeight: 700, marginBottom: '8px', paddingRight: '24px', color: ms.completed ? '#94a3b8' : '#1e293b' }}>{ms.title}</h3>
